; AiScript v0.1.0 Installer (historical archive)
; Inno Setup 6 Script
#define MyAppName "AiScript v0.1.0"
...
AllowNoIcons=yes
OutputDir=output
OutputBaseFilename=AiScript_Setup_v0.1.0
Compression=lzma2
...
UninstallDisplayName=AiScript v0.1.0
...
Source: "..\..\..\AiScript\backups\aiscript_ide_v0.1.0.py"; DestDir: "{app}"; DestName: "aiscript_ide.py"; Flags: ignoreversion
...
[Icons]
Name: "{group}\AiScript 0.1.0 REPL"; Filename: "{sys}\cmd.exe"; Parameters: "/K python ""{app}\aiscript.py"""; WorkingDir: {app}
Name: "{group}\Kite IDE (0.1.0)"; Filename: "{sys}\cmd.exe"; Parameters: "/K pythonw ""{app}\aiscript_ide.py"""; WorkingDir: {app}
Name: "{group}\Uninstall AiScript"; Filename: "{uninstallexe}"
Name: "{commondesktop}\AiScript 0.1.0 REPL"; Filename: "{sys}\cmd.exe"; Parameters: "/K python ""{app}\aiscript.py"""; WorkingDir: {app}
[Registry]
