; AiScript v0.1.2 Installer (historical archive)
; Inno Setup 6 Script
#define MyAppName "AiScript v0.1.2"
...
AllowNoIcons=yes
OutputDir=output
OutputBaseFilename=AiScript_Setup_v0.1.2
Compression=lzma2
...
UninstallDisplayName=AiScript v0.1.2
...
Source: "..\..\..\AiScript\backups\aiscript_ide_v0.1.2.py"; DestDir: "{app}"; DestName: "aiscript_ide.py"; Flags: ignoreversion
Source: "..\..\..\AiScript\backups\kite_v0.1.2.cmd"; DestDir: "{app}"; DestName: "kite.cmd"; Flags: ignoreversion
...
[Icons]
Name: "{group}\AiScript 0.1.2 REPL"; Filename: "{sys}\cmd.exe"; Parameters: "/K python ""{app}\aiscript.py"""; WorkingDir: {app}
Name: "{group}\Kite IDE (0.1.2)"; Filename: "{app}\kite.cmd"; WorkingDir: {app}
Name: "{group}\Uninstall AiScript"; Filename: "{uninstallexe}"
Name: "{commondesktop}\AiScript 0.1.2 REPL"; Filename: "{sys}\cmd.exe"; Parameters: "/K python ""{app}\aiscript.py"""; WorkingDir: {app}
[Registry]
