...
class AiScriptIDE:
    def __init__(self, filepath=None):
        self.root = tk.Tk()
        self.root.title("Kite v{}".format(__version__))
    ...
    def _setup_menu(self):
        ...
        help_menu.add_command(label="About Kite", command=self._show_about)
    ...
    def _new_file(self):
        ...
        self.current_file = None
        self.modified = False
        self.root.title("Kite v{} - Untitled".format(__version__))
    ...
    def _show_about(self):
        messagebox.showinfo("About Kite",
            "Kite v{} — AiScript IDE\n\n"
