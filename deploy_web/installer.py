...
import threading, os, sys, json, re, shutil, time
    ...
    def download_file(self, url, filename):
        ...
        for attempt in range(1, RETRIES + 1):
            try:
                ...
                last_err = e
                if attempt < RETRIES:
                    self.log("  Retry {}/{} for {}".format(attempt, RETRIES, filename), "warn")
                    time.sleep(2)
        raise last_err
    ...
    def _do_install(self):
        ...
        for i, filename in enumerate(ALL_FILES):
            ...
            try:
                ...
                if filename.endswith(".py") and not is_data_bulk(filename):
                    try:
                ...
                if os.path.exists(dest):
                    try:
                        ...
                        self.log("  Backup skipped (no permission): {}.bak".format(filename), "warn")
